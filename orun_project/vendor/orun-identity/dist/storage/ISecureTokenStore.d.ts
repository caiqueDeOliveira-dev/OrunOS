...
export declare const TOKEN_STORE_KEYS: {
    readonly ACCESS_TOKEN: "orun.identity.access_token";
    readonly REFRESH_TOKEN: "orun.identity.refresh_token";
    readonly LICENSE_TOKEN: "orun.identity.license_token";
    readonly DEVICE_ID: "orun.identity.device_id";
};
//# sourceMappingURL=ISecureTokenStore.d.ts.map