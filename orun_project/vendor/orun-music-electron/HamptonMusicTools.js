    ...
    return [
        ...
        },
        {
            ...
            handler: async ({ name }) => {
                ...
                if (!match || match.trackIds.length === 0)
                    return { ok: false, reason: 'playlist não encontrada ou vazia' };
        ...
        },
        {
            ...
            handler: async () => {
                ...
                if (!state?.trackId)
                    return { ok: false, reason: 'nada tocando no momento' };
        ...
        },
        {
            ...
            handler: async ({ playlistId }) => {
                ...
                if (!playlist)
                    return { ok: false, reason: 'playlist não encontrada' };
...
//# sourceMappingURL=HamptonMusicTools.js.map