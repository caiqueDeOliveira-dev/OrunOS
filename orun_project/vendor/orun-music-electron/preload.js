...
contextBridge.exposeInMainWorld('orunMusicBridge', {
    getSpotifyAccessToken: () => ipcRenderer.invoke('orun-music:get-spotify-token'),
    getSpotifyUserId: () => ipcRenderer.invoke('orun-music:get-spotify-user-id'),
    getMusixmatchApiKey: () => ipcRenderer.invoke('orun-music:get-musixmatch-key'),
});
