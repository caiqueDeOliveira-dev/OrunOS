import type { TelemetryPayload, IdentifyTraits } from "./schema";
...
export interface ITelemetryStore {
    ...
    /** Enfileira um evento (envelope é preenchido automaticamente pelo core). */
    track(payload: TelemetryPayload): Promise<void>;
