...
const btnStyle: React.CSSProperties = {
  ...
  cursor: "pointer", borderRadius: 3, transition: "all 0.12s",
};
  ...
  return (
    ...
    >
      ...
      <button onClick={() => useVideoStore.setState((s) => ({ isPlaying: !s.isPlaying }))}
        style={{ display: "flex", alignItems: "center", justifyContent: "center", background: "#C00018", border: "none", width: 32, height: 32, color: "#fff", cursor: "pointer", borderRadius: "50%", transition: "all 0.12s" }}
