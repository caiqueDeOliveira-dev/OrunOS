import {
  ...
  Scale, Wrench, LifeBuoy, MessageSquare, MessageSquareText, Shield, House, Gamepad2, Briefcase, Atom,
} from "lucide-react";
...
export function getAgents(t: T) {
  return [
    ...
    { name: "Neural", persona: "Lima Barreto", role: t("agentNeural"), icon: Atom },
  ];
}
